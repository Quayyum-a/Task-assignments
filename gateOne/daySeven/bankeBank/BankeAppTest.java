...
public class BankeAppTest {
    ...
    @Test
    public void test_AccountExists(){
        BankeApp app = new BankeApp();
    ...
    @Test
    public void test_TransferFromNonExistingAccount(){
        BankeApp sender = new BankeApp();
        BankeApp receiver = new BankeApp();
    ...
    public void test_ChangePin_Success() {
        BankeApp app = new BankeApp();
        app.createAccount("John", "Doe", 1234);
        app.changePin(1234, 5678);
        assertTrue(app.verifyPin(5678));
    }
    ...
    @Test
    public void test_ChangePinWithNoAccount(){
        BankeApp app = new BankeApp();
        Exception exception = assertThrows(IllegalStateException.class, () -> {
            app.changePin(1234, 56789);
        });
    ...
    @Test
    public void test_VerifyPin(){
        BankeApp app = new BankeApp();
        app.createAccount("John", "Doe", 1234);
        assertTrue(app.verifyPin(1234));
    }

    @Test
    public void test_VerifyInvalidPin() {
        BankeApp app = new BankeApp();
        app.createAccount("John", "Doe", 1234);
        Exception exception = assertThrows(IllegalArgumentException.class, () -> {
            app.verifyPin(1235);
