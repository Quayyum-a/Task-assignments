    ...
    public static void main(String... args) {
        ...
        while (true) {
            ...
            if (input.hasNextInt()) { 
                ...
                if (numStudents > 0) { 
                    ...
                    System.out.println("Please enter a positive number greater than 0 for the number of students.");
                }
            } else {
        ...
        while (true) {
            ...
            if (input.hasNextInt()) { 
                ...
                if (numSubjects > 0) { 
                    ...
                    System.out.println("Please enter a positive number greater than 0 for the number of subjects.");
                }
            } else {
        ...
        for (int student = 0; student < numStudents; student++) {
            for (int subject = 0; subject < numSubjects; subject++) {
                while (true) {
                    System.out.print("Enter the grade for student " + (student + 1) + ", subject " + (subject + 1) + ": ");
                    if (input.hasNextInt()) { 
        ...
        for (int student = 0; student < numStudents; student++) {
            ...
            System.out.printf("%d\t\t%.2f\t\t%d\n", totals[student], average, positions[student]);
        }
		  System.out.println("======================================================================================================\n");
		  System.out.println("======================================================================================================");
        ...
        for (int subject = 0; subject < numSubjects; subject++) {
            ...
            System.out.println("Total Score ish: " + totalScore);
